...
import SQSCommands.NewTaskCommand;
...
public class SQSProtocol {
	 ...
	 * @return an executable {@link SQSCommand} or null if the command is TERMINATE
	 * @throws MalformedMessageException if the given string doesn't match the protocol
	 */
	public static SQSCommand parse(String message) throws MalformedMessageException {
